...
import React from './component/kreact';
import Component from "./component/kreact/Component";
import ReactDOM from './component/kreact-dom';
import './index.css';
import App from './App';
...
class ClassComponent extends Component{
    ...
    render(){
        ...
        return <h2 className="border function">hello, {name}, {desc}</h2>
    }
}
